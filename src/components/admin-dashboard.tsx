...
import { FileText, Users, ShieldCheck, ShieldX, PlusCircle, Loader2, ShieldAlert, DollarSign } from 'lucide-react';
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-6">
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Total revenue from all policies</p>
                </CardContent>
            </Card>
